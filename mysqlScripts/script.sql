...
CREATE TABLE linksexam1 (id INT NOT NULL AUTO_INCREMENT, name VARCHAR(200) NOT NULL, link VARCHAR(2000) NOT NULL, after INT NOT NULL, PRIMARY KEY (id));
INSERT INTO linksexam1 (name,link,after) VALUES('Intro Video','https://youtu.be/lDdtbynxyA0','0');
INSERT INTO linksexam1 (name,link,after) VALUES('Survey Prompt Link','https://oregon.qualtrics.com/jfe/form/SV_3ITkIqti7gfcHwp','10');
INSERT INTO linksexam1 (name,link,after) VALUES('Pre exam Link','https://oregon.qualtrics.com/jfe/form/SV_29uye3Rm6EvZw7r','0');
